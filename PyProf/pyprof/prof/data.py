            ...
            for key, value in params.items():
                if "type" not in key:
                    ...
                    if type(value) is str:
                        qaz += "type={},".format(Utility.typeToString(value))
                    elif type(value) is list:
                        for i in value:
                            qaz += "type={},".format(Utility.typeToString(i))
                    else:
                        logging.info(f"type value is f{value}, type = {type(value)}")
                        qaz += "type={}".format(value)
