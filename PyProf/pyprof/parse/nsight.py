...
class Nsight(object):
    ...
    def getMarkerInfo(self, objId, startTime, endTime):
        ...
        for r in result:
            ...
            if ("_backward, seq =" in m) or ("Backward, seq =" in m) or ("Backward0, seq =" in m) or (
                    "Backward1, seq" in m) or ('backward, seq =' in m):
                bprop = True
        ...
        if (len(otherMarkers)):
            ...
            otherMarkers.sort(key=opcompare, reverse=True)
