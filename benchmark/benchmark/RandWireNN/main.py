...
from benchmark.RandWireNN.preprocess import load_data
from benchmark.RandWireNN.plot import draw_plot
...
def main():
    ...
    parser.add_argument('--is-train', type=bool, default=True, help="True if training, False if config_test. (default: True)")
    parser.add_argument('--load-model', type=bool, default=False)

    args = parser.parse_args()

    train_loader, test_loader = load_data(args.dataset_mode, args.batch_size)
